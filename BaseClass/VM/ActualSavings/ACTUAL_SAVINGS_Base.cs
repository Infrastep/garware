...
{
     public class ACTUAL_SAVINGS_Base_ACS
     {
         ...
         public virtual EMP_FIXED_Base_ACS EMP_FIXED { get; set; }
         public virtual TAX_CODE_Base_ACS TAX_CODE { get; set; }
         public virtual AGREEMENT_DETAILS_Base_ACS AGREEMENT_DETAILS { get; set; }
    }
}
