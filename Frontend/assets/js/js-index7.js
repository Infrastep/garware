...
jQuery(function() {
    jQuery("#datepicker,#datepicker2,#datepicker3,#datepicker4,#datepicker5,#datepicker6,#datepicker7,#datepicker8,#datepicker9,#datepicker10,#datepicker11,#datepicker12,#datepicker13,#datepicker14,#datepicker15,#datepicker16,#Validity,#issue,#ValidityCdc,#issueCdc,#ValidityPan,#issuePan,#ValidityMedi,#issueMedi,#ValidityDC,#ServiceFrom,#ServiceTo").datepicker();
});
