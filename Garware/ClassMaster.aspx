<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ClassMaster.aspx.cs" Inherits="Garware.ClassMaster" %>
            ...
            <asp:RoleGroup>
                <ContentTemplate>
                    <div class="page-content">
                        ...
                        <!-- BEGIN PAGE HEADER-->
                        <div class="col-lg-12 col-md-12">
                            <h5 class="page-title">Class Master 
                            </h5>
                        </div>
                                ...
                                <div class="portlet box red bg-inverse">
                                    ...
                                    <div class="portlet-body form" style="display: block;">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <input type="checkbox" checked="checked" class="make-switch" data-size="large" id="ClassStatus" />

                                                            </div>
                                                        </div>

                                                        <div class="form-group ">
                                                            <label class="control-label col-md-3">Class Type</label>
                                                            <div class="col-md-9">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Cost to company</label>
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <input type="checkbox" checked="checked" class="make-switch" data-size="large" id="CosttoComp" />
                                        ...
                                        <div class="form-group ">
                                            <label class="control-label col-md-3">Class Type</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="" id="ClassType" />
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>--%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/ClassMaster.js"></script>
