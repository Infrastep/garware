<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="PortMaster.aspx.cs" Inherits="Garware.PortMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodycontent" runat="server">
    ...
    <asp:LoginView ID="LoginView1" runat="server">
        ...
        <!-- BEGIN PAGE HEADER-->
        <div class="col-lg-12 col-md-12">
            <h5 class="page-title">Port Master 
            </h5>
        </div>
                ...
                <div class="portlet box red bg-inverse">
                    ...
                    <div class="portlet-body form" style="display: block;">
                        ...
                        <div class="form-horizontal">
                            <div class="form-body">
                                <input id="PortID" type="hidden" value="0" />
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="" id="PortName" />
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="" id="PortCode" />
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="col-md-8">
                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="PortTable">
                            <thead>
                                <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/PortMaster.js"></script>
