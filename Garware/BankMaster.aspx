<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="BankMaster.aspx.cs" Inherits="Garware.BankMaster" %>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <input type="checkbox" class="make-switch" data-size="large" id="BankStatus" />
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <button type="submit" class="btn green" id="InsertdataBank">Submit</button>
