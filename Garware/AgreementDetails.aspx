<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="AgreementDetails.aspx.cs" Inherits="Garware.AgreementDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodycontent" runat="server">
    <div class="page-content">
        ...
        <div class="col-lg-12 col-md-12">
            <h5 class="page-title">Agreement Details
            </h5>
        </div>
                               ...
                               <%-- <div class="row">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input class="form-control" id="cerno" type="text" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Saving Date</label>
                                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            <label class="control-label col-md-3">Agreement Details</label>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="AgreementDetailsTable">
                            <thead>
                                <tr>
                                    <th>Contract Ref No.
                                    </th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/AgreementDetails.js"></script>
