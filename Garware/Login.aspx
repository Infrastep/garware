<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Garware.Login" %>
...
<div class="content">
	...
	<div class="login-form">
		...
		<div id="dvvlog" class="alert alert-danger display-hide">
		...
		<div class="form-actions">
			...
			<button type="button" data-loading-text="Loading..." id="btnlog" class="demo-loading-btn btn blue pull-right">
	...
	<div class="forget-form" id="forgot">
        ...
        <asp:PasswordRecovery ID="PasswordRecovery1" runat="server" MailDefinition-From="kunal@infrastep.com" SuccessPageUrl="Login.aspx?forgot=1">
<MailDefinition From="kunal@infrastep.com"></MailDefinition>
            <UserNameTemplate>
               <div class="form-group">
			<div class="input-icon">
				<i class="fa fa-envelope"></i>
                                        <asp:TextBox ID="UserName" CssClass="form-control placeholder-no-fix" runat="server"></asp:TextBox>
                ...
                <div class="form-actions">
                                        <asp:Button ID="SubmitButton" CssClass="btn blue pull-right" runat="server" CommandName="Submit" Text="Submit" ValidationGroup="PasswordRecovery1" />
                                  </div>  
            </UserNameTemplate>
...
<script src="../../assets/admin/layout/scripts/demo.js" type="text/javascript"></script>
    <script src="../../assets/admin/pages/scripts/common.js" type="text/javascript"></script>
<script src="../../assets/admin/pages/scripts/login-soft.js" type="text/javascript"></script>

    <script src="assets/global/scripts/utility.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
    jQuery(document).ready(function () {


        if (utility.Querystring("forgot") === "1") {
        ...
        $.backstretch([
         "../../assets/admin/pages/img/287504.jpg",       
        ], {
            fade: 1000,
            duration: 8000
        }
