<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="WithheldRefund.aspx.cs" Inherits="Garware.WithheldRefund" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodycontent" runat="server">
    <div class="page-content">
        ...
        <div class="col-lg-12 col-md-12">
            <h5 class="page-title">Withheld Refund
            </h5>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="WithheldRefundTable">
                            <thead>
                                <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/WithheldRefund.js"></script>
