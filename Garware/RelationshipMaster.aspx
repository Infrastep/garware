<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="RelationshipMaster.aspx.cs" Inherits="Garware.RelationshipMaster" %>
									...
									<div class="portlet-body form" style="display: block;">
										...
										<div class="form-horizontal">
											<div class="form-body">
												...
												<div class="row">
                                                    <input id="RsmID" type="hidden" value="0" />
													
													<div class="col-md-12">
														<div class="form-group has-error">
															<label class="control-label col-md-3">Relation</label>
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" id="Relation" />
				...
				<div class="col-md-6">
					...
					<div class="portlet box green-haze">
						...
						<div class="portlet-body">
							<table class="table table-striped table-bordered table-hover" id="RelationshipTable">
							<thead>
							<tr>
...
<script src="assets/admin/pages/scripts/RelationshipMaster.js"></script>
<script>
