<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="DGCertifiedDoctors.aspx.cs" Inherits="Garware.DGCertifiedDoctors" %>
            ...
            <asp:RoleGroup>
                <ContentTemplate>
                    <div class="page-content">
                        ...
                        <!-- BEGIN PAGE HEADER-->
                        <div class="col-lg-12 col-md-12">
                            <h5 class="page-title">DG Certified Doctors</h5>
                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" placeholder="" id="DoctorName" />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" placeholder="" id="Clinic" />
                                                                <span class="help-block"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" placeholder="" id="Address1" />
                                                                <span class="help-block"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" placeholder="" id="Address2" />
                                                                <span class="help-block"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box green-haze">
                                    ...
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover" id="DGDoctorsTable">
                                            <thead>
                                                <tr>
                                                    <th>Doctor Name</th>
                                                    <th>Clinic</th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/DGDoctors.js"></script>
    <script>
