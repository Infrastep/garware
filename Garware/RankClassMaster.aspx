<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="RankClassMaster.aspx.cs" Inherits="Garware.RankClassMaster" %>
								...
								<i class="fa fa-globe"></i>Insert Update Data
									...
									<div class="portlet-body form" style="display: block;">
										...
										<div class="form-horizontal">
											<div class="form-body">
												<input id="RankClassID" type="hidden" value="0" />
												<div class="row">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-9">
                                                <input id="clstype" type="text" class="form-control" placeholder="" />
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
				...
				<div class="col-md-8">
					...
					<div class="portlet box green-haze">
						...
						<div class="portlet-body">
							<table class="table table-striped table-bordered table-hover" id="RankClassTable">
							<thead>
							<tr>
...
<script src="assets/admin/pages/scripts/RankClass.js"></script>
