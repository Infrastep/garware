<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="AccountMaster.aspx.cs" Inherits="Garware.AccountMaster" %>
            ...
            <asp:RoleGroup>
                <ContentTemplate>
                    <div class="page-content">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <h5 class="page-title">Account Master
                            </h5>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box green-haze">
                                    ...
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover" id="AccountMasterTable">
                                            <thead>
                                                <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/AccountMaster.js"></script>
