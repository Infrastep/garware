<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="AddresseeMaster.aspx.cs" Inherits="Garware.AddresseeMaster" %>
            ...
            <asp:RoleGroup>
                <ContentTemplate>
                    <div class="page-content">
                        ...
                        <!-- BEGIN PAGE HEADER-->
                        <div class="col-lg-12 col-md-12">
                            <h5 class="page-title">AddressEE Master
                            </h5>
                        </div>
                                ...
                                <div class="portlet box red bg-inverse">
                                    ...
                                    <div class="portlet-body form" style="display: block;">
                                        ...
                                        <div class="form-horizontal">
                                            <div class="form-body">
                                                <input id="AddrID" type="hidden" value="0" />
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" placeholder="" id="Addr0" />
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" placeholder="" id="Addr1" />
                                                                <span class="help-block"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" placeholder="" id="Addr2" />
                                                                <span class="help-block"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" placeholder="" id="Addr4" />
                                                                <span class="help-block"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="portlet box green-haze">
                                    ...
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover" id="AddressTable">
                                            <thead>
                                                <tr>
                                                    <th>Address
                                                    </th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/AddressMaster.js"></script>
    <script>
