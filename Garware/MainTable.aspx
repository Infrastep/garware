<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="MainTable.aspx.cs" Inherits="Garware.MainTable" %>
                            ...
                            <div class="form-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label col-md-6">PAYABLE FOR CREW (Y/N)</label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <input type="checkbox" id="ArticleOffBoard"   />
                                            On Article Off Board
                                        ...
                                        <div class="col-md-12">
                                            <input type="checkbox" id="PostsignOnRetention" />
                                            On Postsign On Retention

                                        </div>
                                        <div class="col-md-12">
                                            <input type="checkbox" id="PresignOnRetention" />
                                            On Presign On Retention

                                        </div>
                                        <div class="col-md-12">
                                            <input type="checkbox" id="UnitAfterSelection" />
                                            On Unit After Selection

                                        </div>
                                        <div class="col-md-12">
                                            <input type="checkbox" id="HospitalizedInIndia" />
                                            On Hospitalized In India

                                        </div>
                                        <div class="col-md-12">
                                            <input type="checkbox" id="HospitalizedInAbroad" />
                                            On Hospitalized In Abroad

                                        </div>
                                        <div class="col-md-12">
                                            <input type="checkbox" id="MedicalInIndia" />
                                            On Medical In India
                                        ...
                                        <div class="col-md-12">
                                            <input type="checkbox" id="LeaveEarned" />
                                            On Leave Earned

                                        </div>
                                        <div class="col-md-12">
                                            <input type="checkbox" id="ContinuousService" />
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="MainTableTable">
                            <thead>
                                <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/MainTable.js"></script>
