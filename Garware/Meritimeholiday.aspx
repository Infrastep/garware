<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="Meritimeholiday.aspx.cs" Inherits="Garware.Meritimeholiday" %>
										...
										<div class="col-md-9">
											<div id="spinnerDay">
												<div class="input-group" style="width:150px;">
													<input type="text" class="spinner-input form-control" id="Daynum" maxlength="3" readonly>
            ...
            <div class="col-md-6">
                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="MeritimeholidayTable">
                            <thead>
                                <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/Meritimeholiday.js"></script>
