var DocTypeViewModel = function () {
    ...
    var initTable2 = function () {
        ...
        var urlToHandler = "/Handler/DocumentTypeMasterHandler.ashx";
        var jsonData;
        jsonData = '{ "Method": "GetDocType"}';
...
$("#Insertdata").click(function () {
    ...
    var urlToHandler = "/Handler/DocumentTypeMasterHandler.ashx";
    jsonData = '{ "Method": "InsertDocType","id":"' + $("#DTID").val() + '","dtname":"' + $("#dttypename").val() + '","status":"' + status + '"}';
