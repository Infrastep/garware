var WithheldTransferViewModel = function () {
    ...
    var initTablecer = function () {
        var table = $('#WithheldTransferTable');
        ...
        var urlToHandler = "Handler/WithheldTransferHandler.ashx";
        var jsonData;
...
$("#InsertdataCC").click(function (evt) {
    ...
    var urlToHandler = "Handler/WithheldTransferHandler.ashx";
    jsonData = '{ "Method": "InsertUpdate","ID":"' + $("#ID").val() + '","EMP_CODE":"' + $("#Emp").val() + '","TRANS_AMT":"' + $("#amount").val() + '","YR":"' + $("#year").val() + '","MON":"' + $("#mon").val() + '","AGREEMENT_CODE":"' + $("#agreement").val() + '"}';
