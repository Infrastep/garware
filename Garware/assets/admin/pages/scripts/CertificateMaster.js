var CertificateViewModel = function () {
    ...
    var initTablecer = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#CID").val(aData.CERTID);
            
            $("#Description").val(aData.CERT_DESC);
            $("#cerValidity").val(aData.VALIDITY.split("T")[0]);
        ...
        var oTable = table.dataTable({
            ...
            "columns": [
                        ...
                        { "data": "CERTIFICATE_TYPE_MASTER.CT_DESC" },
                        {
                            "data": null,
                            "render": function (data, type, full, meta) {
                                return '<a class="edit1" target="_blank" href="uploads/' + full.PATH + '">' + full.PATH + ' </a>';
                            }
                        },
                          {
                              "data": null,
...
$("#InsertdataCC").click(function (evt) {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            var urlToHandler = "/Handler/CertificateMasterHandler.ashx";
            jsonData = '{ "Method": "InsertCM","id":"' + $("#CID").val() + '","eid":"' + $("#EID").val() + '","description":"' + $("#Description").val() + '","validity":"' + $("#cerValidity").val() + '","path":"' + result + '","ctid":"' + $("#CerType").val() + '"}';
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    $("#InsertdataEE").show();
                    $('.nav-tabs li a[href="#sea"]').trigger('click');
