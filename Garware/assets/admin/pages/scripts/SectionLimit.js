var SectionLimitViewModel = function () {
    ...
    var initTable2 = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#SLID").val(aData.ID);
            $("#SectionTitle").val(aData.SECTION);
            $("#SectionLimit").val(aData.MAX_LIMIT);
        ...
        var urlToHandler = "/Handler/SectionLimitHandler.ashx";
        var jsonData;
        jsonData = '{ "Method": "GetSL"}';
...
$("#InsertdataSL").click(function () {
    var table = $('#SectionTable');

    $(table).dataTable().fnDestroy();
    var status = $("input[type='radio'][name='Status']:checked").val();
    var urlToHandler = "/Handler/SectionLimitHandler.ashx";
    jsonData = '{ "Method": "InsertSL","id":"' + $("#SLID").val() + '","section":"' + $("#SectionTitle").val() + '","max":"' + $("#SectionLimit").val() + '","status":"' + status + '" }';
