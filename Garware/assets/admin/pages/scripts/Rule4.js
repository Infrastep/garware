var RULE4ViewModel = function () {
    ...
    var initTablecer = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#Type").val(aData.FIXED_PRCNT_OTRATE_FLAG);
            $("#minlimit").val(aData.MIN_SECONDARY_EARN_AMT);
            $("#maxlimit").val(aData.MAX_SECONDARY_EARN_AMT);
        ...
        var urlToHandler = "Handler/Rule4Handler.ashx";
        var jsonData;
                        ...
                        { "data": "SECONDARY_EARN_DEDN_CODE" },
                         {
                          ...
                          { "data": "EMPL_CLASS" },
                           ...
                           { "data": "FIXED_PRCNT_OTRATE_FLAG" },
                           { "data": "MIN_SECONDARY_EARN_AMT" },
                           { "data": "MAX_SECONDARY_EARN_AMT" },
                            { "data": "EARN_DEDN_RATE" },
...
$("#InsertdataCC").click(function (evt) {
    ...
    var urlToHandler = "Handler/Rule4Handler.ashx";
    jsonData = '{ "Method": "InsertUpdate","RULE4ID":"' + $("#RULE4ID").val() + '","EARN_DEDN_CODE":"' + $("#EarnDedn").val() + '","EMPL_CLASS":"' + $("#Class").val() + '","RULE_WEF_DATE":"' + $("#StDate").val() + '","SECONDARY_EARN_DEDN_CODE":"' + $("#SecEarnDedn").val() + '","EARN_DEDN_RATE":"' + $("#Amount").val() + '","FIXED_PRCNT_OTRATE_FLAG":"' + $("#Type").val() + '","MIN_SECONDARY_EARN_AMT":"' + $("#minlimit").val() + '","MAX_SECONDARY_EARN_AMT":"' + $("#maxlimit").val() + '"}';
