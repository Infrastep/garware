var CountryViewModel = function () {
    ...
    var initTable2 = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#CName").val(aData.C_Name);
            $("#CCode").val(aData.CCODE);
        ...
        var urlToHandler = "/Handler/CountryMasterHandler.ashx";
        var jsonData;
        jsonData = '{ "Method": "GetCountry"}';
...
$("#Insertdata").click(function () {
    ...
    var urlToHandler = "/Handler/CountryMasterHandler.ashx";
    jsonData = '{ "Method": "InsertCOUNTRY","id":"' + $("#CID").val() + '","code":"' + $("#CCode").val() + '","name":"' + $("#CName").val() + '","status":"' + status + '"}';
