var PortViewModel = function () {
    ...
    var initTable2 = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#PortID").val(aData.PID);

            $("#PortName").val(aData.PortName);
            $("#PortCode").val(aData.CCODE);
        ...
        var urlToHandler = "/Handler/PortMasterHandler.ashx";
        var jsonData;
        jsonData = '{ "Method": "GetPM"}';
...
$("#Insertdata").click(function () {
    ...
    var urlToHandler = "/Handler/PortMasterHandler.ashx";
    jsonData = '{ "Method": "InsertPM","id":"' + $("#PortID").val() + '","name":"' + $("#PortName").val() + '","code":"' + $("#PortCode").val() + '","country":"' + $("#Country").val() + '","lat":"' + $("#Latitude").val() + '","lon":"' + $("#Longitude").val() + '","status":"' + status + '"}';
