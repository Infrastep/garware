var ReligionViewModel = function () {
    ...
    var initTable2 = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#ReligionID").val(aData.RELIGIONID);

            $("#ReligionName").val(aData.RELIGION_NAME);
        ...
        var urlToHandler = "/Handler/ReligionMasterHandler.ashx";
        var jsonData;
        jsonData = '{ "Method": "GetRGM"}';
...
$("#Insertdata").click(function () {
    ...
    var urlToHandler = "/Handler/ReligionMasterHandler.ashx";
    jsonData = '{ "Method": "InsertRGM","id":"' + $("#ReligionID").val() + '","name":"' + $("#ReligionName").val() + '","status":"' + status + '"}';
