var RULE9ViewModel = function () {
    ...
    var initTablecer = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#minlimit").val(aData.MIN_NO_OF_DAYS);
        ...
        var urlToHandler = "Handler/Rule9Handler.ashx";
        var jsonData;
...
$("#InsertdataCC").click(function (evt) {
    ...
    var urlToHandler = "Handler/Rule9Handler.ashx";
    jsonData = '{ "Method": "InsertUpdate","RULE9ID":"' + $("#RULE9ID").val() + '","EARN_DEDN_CODE":"' + $("#EarnDedn").val() + '","EMPL_CLASS":"' + $("#Class").val() + '","RULE_WEF_DATE":"' + $("#StDate").val() + '","SECONDARY_EARN_DEDN_CODE":"' + $("#SecEarnDedn").val() + '","MAX_NO_OF_DAYS":"' + $("#maxlimit").val() + '","MIN_NO_OF_DAYS":"' + $("#minlimit").val() + '","EARN_PRCNT":"' + $("#percentage").val() + '"}';
