var RelationShipViewModel = function () {
    ...
    var initTable2 = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#RsmID").val(aData.RELATIONSHIPID);

            $("#Relation").val(aData.RELATION);
        ...
        var urlToHandler = "/Handler/RelationshipMasterHandler.ashx";
        var jsonData;
        jsonData = '{ "Method": "GetRSM"}';
...
$("#Insertdata").click(function () {
    ...
    var urlToHandler = "/Handler/RelationshipMasterHandler.ashx";
    jsonData = '{ "Method": "InsertRSM","id":"' + $("#RsmID").val() + '","relation":"' + $("#Relation").val() + '","status":"' + status + '"}';
