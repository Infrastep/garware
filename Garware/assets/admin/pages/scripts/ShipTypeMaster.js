var ShipTypeViewModel = function () {
    ...
    var initTable2 = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#Hiddenid").val(aData.TypeID);
          
            $("#TypeDescription").val(aData.Description);
        ...
        var table = $('#ShipTypeTable');


        

        var urlToHandler = "/Handler/Ship_Type_MasterHandler.ashx";
        var jsonData;
        jsonData = '{ "Method": "GetSTM"}';
...
$("#Insertdata").click(function () {
    ...
    var urlToHandler = "/Handler/Ship_Type_MasterHandler.ashx";
    jsonData = '{ "Method": "InsertSTM","id":"' + $("#Hiddenid").val() + '","description":"' + $("#TypeDescription").val() + '","status":"' + status + '"}';
