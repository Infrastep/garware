var RULE8ViewModel = function () {
    ...
    var initTablecer = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#Type").val(aData.FIXED_PRCNT_FLAG);
            var ship = aData.SHIP_CODE.trim();
            $("#ShipId").val(ship);
            $("#Monthnum").val(aData.PROLONG_FROM_MONTH);
            $("#Monthnum1").val(aData.PROLONG_TO_MONTH);
        ...
        var urlToHandler = "Handler/Rule8Handler.ashx";
        var jsonData;
            ...
            "columns": [
                        ...
                        { "data": "EARN_DEDN_CODE" },
                        ...
                        
                         {
                          ...
                          { "data": "EMPL_CLASS" },
                          { "data": "PROLONG_FROM_MONTH" },

                            { "data": "PROLONG_TO_MONTH" },
                            { "data": "PRCNT_IN_THIRD_PERIOD" },
                          { "data": "PRCNT_IN_FIRST_PERIOD" },

                            { "data": "PRCNT_IN_SECOND_PERIOD" },
...
$("#InsertdataCC").click(function (evt) {
    ...
    var urlToHandler = "Handler/Rule8Handler.ashx";
    jsonData = '{ "Method": "InsertUpdate","RULE8ID":"' + $("#RULE8ID").val() + '","EARN_DEDN_CODE":"' + $("#EarnDedn").val() + '","EMPL_CLASS":"' + $("#Class").val() + '","RULE_WEF_DATE":"' + $("#StDate").val() + '","SECONDARY_EARN_DEDN_CODE":"' + $("#SecEarnDedn").val() + '","SHIP_CODE":"' + $("#ShipId").val() + '","PROLONG_FROM_MONTH":"' + $("#Monthnum").val() + '","PROLONG_TO_MONTH":"' + $("#Monthnum1").val() + '","PRCNT_IN_FIRST_PERIOD":"' + $("#fperiod").val() + '","PRCNT_IN_SECOND_PERIOD":"' + $("#speriod").val() + '","PRCNT_IN_THIRD_PERIOD":"' + $("#nperiod").val() + '"}';
