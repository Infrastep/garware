var RULE2ViewModel = function () {
    ...
    var initTablecer = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#percentage").val(aData.EARN_DEDN_RATE);
        ...
        var urlToHandler = "Handler/Rule2Handler.ashx";
        var jsonData;
...
$("#InsertdataCC").click(function (evt) {
    ...
    var urlToHandler = "Handler/Rule2Handler.ashx";
    jsonData = '{ "Method": "InsertUpdate","RULE2ID":"' + $("#RULE2ID").val() + '","EARN_DEDN_CODE":"' + $("#EarnDedn").val() + '","EMPL_CLASS":"' + $("#Class").val() + '","RULE_WEF_DATE":"' + $("#StDate").val() + '","SECONDARY_EARN_DEDN_CODE":"' + $("#SecEarnDedn").val() + '","EARN_DEDN_RATE":"' + $("#percentage").val() + '"}';
