var CertificateTypeViewModel = function () {
    ...
    var initTablecer = function () {
        var table = $('#CertificateTypeTable');
        ...
        var urlToHandler = "/Handler/CertificateTypeMasterHandler.ashx";
        var jsonData;
        jsonData = '{ "Method": "GetCTM"}';
...
$("#InsertdataCC").click(function (evt) {
    ...
    var urlToHandler = "/Handler/CertificateTypeMasterHandler.ashx";
    jsonData = '{ "Method": "InsertCTM","id":"' + $("#CTID").val() + '","description":"' + $("#Description").val() + '","status":"' + status + '"}';
