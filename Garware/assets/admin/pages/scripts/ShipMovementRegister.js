var ShipMovementRegisterViewModel = function () {
    ...
    var initTablecer = function () {
        var table = $('#ShipMovementRegisterTable');
        ...
        var urlToHandler = "Handler/ShipMovementRegisterHandler.ashx";
        var jsonData;
...
$("#InsertdataCC").click(function (evt) {
    ...
    var urlToHandler = "Handler/ShipMovementRegisterHandler.ashx";
    jsonData = '{ "Method": "InsertUpdate","ID":"' + $("#ID").val() + '","SHIPCODE":"' + $("#Ship").val() + '","WATER":"' + $("#WaterType").val() + '","FROM_DATE":"' + $("#StDate").val() + '","TO_DATE":"' + $("#EdDate").val() + '"}';
