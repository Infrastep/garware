var EarndedViewModel = function () {
    ...
    var initTablecer = function () {
        ...
        var urlToHandler = "Handler/EarningDeductionMasterHandler.ashx";
        var jsonData;
...
$("#InsertdataCC").click(function (evt) {
    ...
    var urlToHandler = "Handler/EarningDeductionMasterHandler.ashx";
    jsonData = '{ "Method": "InsertUpdate","id":"' + $("#EarndedID").val() + '","CODE":"' + $("#EarnDedn").val() + '","DESCRIPTION":"' + $("#EarnDednDesc").val() + '"}';
