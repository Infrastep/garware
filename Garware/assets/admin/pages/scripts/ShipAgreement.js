var ShipAgreementViewModel = function () {
    ...
    var initTablecer = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#ClientType").val(aData.AgreementType);
        ...
        var urlToHandler = "Handler/ShipAgreementHandler.ashx";
        var jsonData;
...
$("#InsertdataCC").click(function (evt) {
    ...
    var urlToHandler = "Handler/ShipAgreementHandler.ashx";
    jsonData = '{ "Method": "InsertUpdate","id":"' + $("#SAID").val() + '","ClientId":"' + $("#Client").val() + '","ShipId":"' + $("#Ship").val() + '","AgreementType":"' + $("#ClientType").val() + '","Startdate":"' + $("#StDate").val() + '","Enddate":"' + $("#EdDate").val() + '"}';
