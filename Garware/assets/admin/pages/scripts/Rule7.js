var RULE7ViewModel = function () {
    ...
    var initTablecer = function () {
        ...
        var urlToHandler = "Handler/Rule7Handler.ashx";
        var jsonData;
...
$("#InsertdataCC").click(function (evt) {
    ...
    var urlToHandler = "Handler/Rule7Handler.ashx";
    jsonData = '{ "Method": "InsertUpdate","RULE7ID":"' + $("#RULE7ID").val() + '","EARN_DEDN_CODE":"' + $("#EarnDedn").val() + '","EMPL_CLASS":"' + $("#Class").val() + '","RULE_WEF_DATE":"' + $("#StDate").val() + '","MAX_NO_OF_YRS":"' + $("#maxyr").val() + '","MIN_NO_OF_YRS":"' + $("#minyr").val() + '","EARN_DEDN_RATE":"' + $("#rate").val() + '"}';
