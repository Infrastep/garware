var MiscTaxableIncomeViewModel = function () {
    ...
    var initTablecer = function () {
        var table = $('#MiscTaxableIncomeTable');
        ...
        function editRow(oTable, nRow) {
            ...
            $("#narration").val(aData.NARRATION);
           
            $("#utilised").val(aData.UTILISED);
            $("#tax").val(aData.TAX_AMT_DED);
            $("#otherincome").val(aData.INCOME_CODE);
            $("#utilised").val(aData.UTILISED);
            $("#cess").val(aData.CESS_DED);
            $("#schg").val(aData.SCHG_DED);
            $("#total").val(aData.TAX_DED);
        ...
        var urlToHandler = "Handler/MiscTaxableIncomeHandler.ashx";
        var jsonData;
...
$("#InsertdataCC").click(function (evt) {
    ...
    jsonData = '{ "Method": "InsertUpdate","MISC_TAXABLE_INCOME_ID":"' + $("#MISCID").val() + '","EMP_CODE":"' + $("#Emp").val() + '","AMOUNT":"' + $("#amount").val() + '","FINANCIAL_YEAR":"' + $("#fyear").val() + '","NARRATION":"' + $("#narration").val() + '","INCOME_CODE":"' + $("#otherincome").val() + '","ENTRY_DATE":"' + $("#StDate").val() + '","UTILISED":"' + $("#utilised").val() + '","TAX_DED":"' + $("#total").val() + '","TAX_AMT_DED":"' + $("#tax").val() + '","SCHG_DED":"' + $("#schg").val() + '","CESS_DED":"' + $("#cess").val() + '"}';
