...
var CompanyBranchViewModel = function () {
    ...
    var initTableBranch = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#chequeno").val(aData.CHEQUE_NAME);
        ...
        var urlToHandler = "/Handler/CompanyBranchHandler.ashx";
        var jsonData;
        jsonData = '{ "Method": "GetCB","id":"' + $("#companyId").val() + '"}';
...
$("#InsertdataCB").click(function () {
    ...
    var urlToHandler = "/Handler/CompanyBranchHandler.ashx";
    jsonData = '{ "Method": "InsertCBM","id":"' + $("#CBID").val() + '","cid":"' + $("#companyId").val() + '","branch":"' + $("#Branch").val() + '" ,"chq":"' + $("#chequeno").val() + '" }';
