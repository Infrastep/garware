var NonRecoveryViewModel = function () {
    ...
    var initTablecer = function () {
        ...
        var urlToHandler = "Handler/NonRecoveryHandler.ashx";
        var jsonData;
...
$("#InsertdataCC").click(function (evt) {
    ...
    var urlToHandler = "Handler/NonRecoveryHandler.ashx";
    jsonData = '{ "Method": "InsertUpdate","ID":"' + $("#ID").val() + '","EMP_CODE":"' + $("#Emp").val() + '","AMOUNT":"' + $("#amount").val() + '","REMARKS":"' + $("#remark").val() + '"}';
