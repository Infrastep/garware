var RULE3ViewModel = function () {
    ...
    var initTablecer = function () {
        ...
        var urlToHandler = "Handler/Rule3Handler.ashx";
        var jsonData;
...
$("#InsertdataCC").click(function (evt) {
    ...
    var urlToHandler = "Handler/Rule3Handler.ashx";
    jsonData = '{ "Method": "InsertUpdate","RULE3ID":"' + $("#RULE3ID").val() + '","EARN_DEDN_CODE":"' + $("#EarnDedn").val() + '","EMPL_CLASS":"' + $("#Class").val() + '","RULE_WEF_DATE":"' + $("#StDate").val() + '","SECONDARY_EARN_DEDN_CODE":"' + $("#SecEarnDedn").val() + '","EARN_DEDN_RATE":"' + $("#Amount").val() + '","RANK_CODE":"' + $("#RankId").val() + '","FIXED_PRCNT_DPM_FLAG":"' + $("#Type").val() + '"}';
