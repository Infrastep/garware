var SalutationViewModel = function () {
    ...
    var initTableSalutation = function () {
        var table = $('#SalutationTable');
        ...
        function editRow(oTable, nRow) {
            ...
            $("#SID").val(aData.SalutationID);

            $("#SalutationName").val(aData.SalutationName);
        ...
        var urlToHandler = "/Handler/SalutationHandler.ashx";
        var jsonData;
...
$("#InsertdataST").click(function () {
    ...
    jsonData = '{ "Method": "InsertSM","id":"' + $("#SID").val() + '","name":"' + $("#SalutationName").val() + '","status":"' + status + '"}';
    var datax;
    $.ajax({
        url: urlToHandler,
        data: jsonData,
