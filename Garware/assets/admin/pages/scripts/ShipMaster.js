var ShipViewModel = function () {
    ...
    var initTable2 = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            $("#VesselName").val(aData.VNAME);
            $("#Port").val(aData.PORT_REG_TRADE);
            $("#Trade").val(aData.AREA_OF_OPERATION);
            $("#OffNo").val(aData.OFFICIAL_NO);
            $("#IMO").val(aData.OFF_IMO_NO);
            $("#GT").val(aData.GT_POWER);
            $("#Power").val(aData.POWER_KW_BHP);
            $("#Crew").val(aData.NO_OF_CREW);
            $("#ShipType").val(aData.SHIP_TYPE_MASTER.TypeID);
            $("#NRT").val(aData.NRT);
            $("#Country").val(aData.COUNTRY_MASTER.CID);

            $("#Client").val(aData.CLIENT_MASTER.CLIENTID);
        ...
        $.fn.dataTable.ext.search.push(
            function (settings, data, dataIndex) {
                var val1 = $('#Client1').val();
                var clnt = data[1];// use data for the age column
        ...
        $.fn.dataTable.ext.search.push(
            function (settings, data, dataIndex) {
                var val1 = $('#ShipType1').val();
                var clnt = data[5];// use data for the age column
