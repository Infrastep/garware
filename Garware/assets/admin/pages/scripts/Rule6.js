var RULE6ViewModel = function () {
    ...
    var initTablecer = function () {
        ...
        var urlToHandler = "Handler/Rule6Handler.ashx";
        var jsonData;
...
function BindCertificateById(certid) {

    $('#CertificateName').html();
    var urlToHandler1 = "/Handler/CertificateMasterHandler.ashx";
    jsonData1 = '{ "Method": "GetCMById","id":"' + certid + '"}';
    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            $('#CertificateName').append($("<option />").val(value.CERTID).text(value.CERT_DESC));
...
$("#InsertdataCC").click(function (evt) {
    ...
    var urlToHandler = "Handler/Rule6Handler.ashx";
    jsonData = '{ "Method": "InsertUpdate","RULE6ID":"' + $("#RULE6ID").val() + '","EARN_DEDN_CODE":"' + $("#EarnDedn").val() + '","EMPL_CLASS":"' + $("#Class").val() + '","RULE_WEF_DATE":"' + $("#StDate").val() + '","SECONDARY_EARN_DEDN_CODE":"' + $("#SecEarnDedn").val() + '","EARN_DEDN_RATE":"' + $("#amount").val() + '","FIXED_PRCNT_FLAG":"' + $("#Type").val() + '","RANK_CODE":"' + $("#RankId").val() + '","CERT_CODE":"' + $("#Certificate").val() + '"}';
