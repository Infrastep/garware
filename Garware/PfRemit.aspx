<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="PfRemit.aspx.cs" Inherits="Garware.PfRemit" %>
                        ...
                        <div class="form-horizontal">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="PfID" type="hidden" value="0" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <fieldset>
                                            <legend>PF Contribution Admn Charge Cheque Details</legend>
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input class="form-control" id="radmnno" type="text" />
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Date</label>
                                                        <div class="col-md-4">
                                                            <input class="form-control" id="radmndate" type="text" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Amount</label>
                                                        <div class="col-md-4">
                                                            <input class="form-control" id="radmnamount" type="text" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Bank</label>
                                                        <div class="col-md-4">
                                                            <input class="form-control" id="radmnbank" type="text" />
                        ...
                        <table class="table table-striped table-bordered table-hover" id="PfRemitTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Admin Charges Cheque Details
                                    </th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/PfRemit.js"></script>
