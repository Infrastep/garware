<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="Garware.Category" %>
                                ...
                                <div class="portlet box red bg-inverse">
                                    ...
                                    <div class="portlet-body form" style="display: block;">
                                        ...
                                        <div class="form-horizontal">
                                            <div class="form-body">
                                                <input id="CTID" type="hidden" value="0" />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" class="form-control" placeholder="" id="CategoryName" />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" class="form-control" placeholder="" id="CategoryCode" />
                                                                <span class="help-block"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row" style="display: none">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group ">
                                                            <label class="control-label col-md-4">Leave System</label>
                                                            <div class="col-md-8">
                                                                <select class="form-control" id="CategoryLeave">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            <label class="control-label col-md-4">Shore Float</label>
                                            <div class="col-md-8">
                                                <select class="form-control" id="CategoryShore">
                                                    <option value="">Please Select</option>
                                                    <option value="1">Yes</option>
                                                    <option value="0">No</option>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                <div class="col-md-offset-3 col-md-9">
                                                                    <button type="button" class="btn green" id="InsertdataCT">Submit</button>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/Category.js"></script>
    <script>
