<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="SalutationMaster.aspx.cs" Inherits="Garware.SalutationMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodycontent" runat="server">
    <asp:LoginView ID="LoginView1" runat="server">
        ...
        <div class="col-lg-12 col-md-12">
            <h5 class="page-title">Salutation Master 
            </h5>
        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="SalutationMasterTable">
                            <thead>
                                <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/SalutationMaster.js"></script>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            SalutationMasterViewModel.init();
        });
    </script>
</asp:Content>
