<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ReligionMaster.aspx.cs" Inherits="Garware.ReligionMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodycontent" runat="server">
    <asp:LoginView ID="LoginView1" runat="server">
        ...
        <!-- BEGIN PAGE HEADER-->
        <div class="col-lg-12 col-md-12">
            <h5 class="page-title">Religion Master 
            </h5>
        </div>
                ...
                <div class="portlet box red bg-inverse">
                    ...
                    <div class="portlet-body form" style="display: block;">
                        ...
                        <div class="form-horizontal">
                            <div class="form-body">
                                <input id="ReligionID" type="hidden" value="0" />
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="" id="ReligionName" />
            ...
            <div class="col-md-8">
                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="ReligionTable">
                            <thead>
                                <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/ReligionMaster.js"></script>
    <script>
