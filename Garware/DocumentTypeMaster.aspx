<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="DocumentTypeMaster.aspx.cs" Inherits="Garware.DocumentTypeMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodycontent" runat="server">
    <asp:LoginView ID="LoginView1" runat="server">
        ...
        <div class="col-lg-12 col-md-12">
            <h5 class="page-title">Document Type Master</h5>
        </div>
                ...
                <div class="portlet box red bg-inverse">
                    ...
                    <div class="portlet-body form" style="display: block;">
                        ...
                        <div class="form-horizontal">
                            <div class="form-body">
                                <input id="DTID" type="hidden" value="0" />
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Doc Type Name</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="" id="dttypename" />
            ...
            <div class="col-md-8">
                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="DocTypeTable">
                            <thead>
                                <tr>
                                    <th>Doc Type Name
                                    </th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/DocumentTypeMaster.js"></script>
    <script>
