<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ShipTypeMaster.aspx.cs" Inherits="Garware.ShipTypeMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodycontent" runat="server">
    <asp:LoginView ID="LoginView1" runat="server">
        ...
        <div class="col-lg-12 col-md-12">
            <h5 class="page-title">Ship Type Master 
            </h5>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group has-error">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="" id="TypeDescription" />
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                <button type="button" id="Insertdata" class="btn green">Submit</button>
            ...
            <div class="col-md-6">
                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="ShipTypeTable">
                            <thead>
                                <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/ShipTypeMaster.js"></script>
    <script>
