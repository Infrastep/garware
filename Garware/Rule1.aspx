<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="Rule1.aspx.cs" Inherits="Garware.Rule1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodycontent" runat="server">
    <asp:LoginView ID="LoginView1" runat="server">
        ...
        <div class="col-lg-12 col-md-12">
            <h5 class="page-title">Maintain Class Dependent Fixed Rates
            </h5>
        </div>
                    ...
                    <div class="portlet-body form" style="display: none;">
                        ...
                        <div class="form-horizontal">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <input id="RULE1ID" type="hidden" value="0" />
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="RULE1Table">
                            <thead>
                                <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/common.js"></script>
     <script src="assets/admin/pages/scripts/Rule1.js"></script>
