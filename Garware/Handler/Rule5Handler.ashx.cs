...
{
    /// <summary>
    /// Summary description for Rule5Handler
    /// </summary>
    public class Rule5Handler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            switch (data)
            {
                case "InsertUpdate":
                    ...
                    RULE5_Base obj = new RULE5_Base();
                    obj.RULE5ID = Convert.ToInt32(postdata.RULE5ID.ToString());
                ...
                case "Getdata":
                    ...
                    jstring = JsonConvert.SerializeObject(RULE5BC.getdata());
                    break;
            }
