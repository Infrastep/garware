<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="CertificateTypeMaster.aspx.cs" Inherits="Garware.CertificateTypeMaster" %>
            ...
            <asp:RoleGroup>
                <ContentTemplate>
                    <div class="page-content">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <h5 class="page-title">Certificate Type Master 
                            </h5>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box green-haze">
                                    ...
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover" id="CertificateTypeTable">
                                            <thead>
                                                <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/CertificateTypeMaster.js"></script>
