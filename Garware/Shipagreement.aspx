<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="Shipagreement.aspx.cs" Inherits="Garware.Shipagreement" %>
                    ...
                    <div class="portlet-body form" style="display: block;">
                        ...
                        <div class="form-horizontal">
                            <div class="form-body">
                                    ...
                                    <div class="row">
                                         <input id="SAID" type="hidden" value="0" />
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            <label class="control-label col-md-3">Agreement Type</label>
            ...
            <div class="col-md-6">
                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="ShipAgreementTable">
                            <thead>
                                <tr>
                                    <th>Client
                                    </th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footercontent" runat="server">
    ...
    <script src="assets/admin/pages/scripts/ShipAgreement.js"></script>
